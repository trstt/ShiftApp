...
(function(a, h) {
    ...
    a.create = function(d, b) {
        ...
        if (b || "<" !== d[0]) {
            ...
            k[k.length++] = e
        } else e = f.createElement("div"), c ? MSApp.execUnsafeLocalFunction(function() {
            e.innerHTML = d.trim()
...
(function(a) {
    var h = window.location.pathname + window.location.search,
        g = function() {
            ...
            if ("complete" === document.readyState || "loaded" === document.readyState)
                ...
                else a(window).one("afui:init", function() {
                    d.autoBoot()
                });
    ...
    g.prototype = {
        ...
        ready: function(c) {
            ...
            else a(document).one("afui:ready", function() {
                c()
            })
        },
        goBack: function(c) {
            ...
            if (0 !== d.length && this.views[d.prop("id")]) {
                ...
                if (0 !== b.length && (c = b.pop(), 0 !== c.length))
                    if (0 < b.length) {
                        if ((b = b[b.length - 1].target) && c.target !== b) this.runTransition(c.transition, c.target, b, !0), this.loadContentData(b, d, !0), this.updateHash(b.id)
                    } else try {
        ...
        updateHash: function(c) {
            if (this.manageHistory) {
                ...
                try {
                    window.history.replaceState(b, b, h + c), a(window).trigger("hashchange", null, {
                        newUrl: h + c,
                        oldUrl: h + d
                    })
                } catch (f) {}
        ...
        loadAjax: function(c, b, f, g, h) {
            ...
            if (0 < q.length)
                if (n) k.showLoading && k.showMask("Loading Content"), a.ajax(c).then(function(a) {
                    q.html(a);
...
(function(a) {
    ...
    if (!a.os.supportsTouch) {
        ...
        window.navigator.msPointerEnabled ? (document.addEventListener("MSPointerDown", function(a) {
            ...
            if (d) return c("touchend", a, m, !0), m = null, d = !1, !0
